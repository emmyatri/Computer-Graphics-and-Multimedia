 ...
 * Professor: Alan Shaw
 * Assignment #: Mod6, Assignment1, Lab2
 */
...
window.onload = function init() {
    ...
    document.getElementById("imageVal").oninput =
        function (event) {
    ...
    document.getElementById("lighting").oninput =
        function (event) {
            gl.uniform1i(lightingLoc, event.target.checked);
        };

    document.getElementById("rotateLighting").oninput =
        function (event) {
